...
(function (global, factory) {
  ...
  */
   ...
   * @template T
   */
  var alignWithDOM = function (nodeName, key, opt_initCallback, opt_initData) {
   ...
   * @template T
   */
  var coreElementOpen = function (tag, key, initCallback, initData) {
    nextNode();
   ...
   * @param {?Array<*>=} statics
   */
  var initElement = function (node, statics) {
    if (!statics) {
      return;
    }
  ...
  var elementOpen = function (tag, key, statics, const_args) {
    ...
    var node = coreElementOpen(tag, key, initElement, statics);
    var data = getData(node);
